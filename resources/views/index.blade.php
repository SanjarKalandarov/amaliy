            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Tozalash xizmatlari</h5>
                            <h1 class="display-3 text-white mb-md-4">Tozalashda eng yaxshi sifatli yechim</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Tozalash xizmatlari</h5>
                            <h1 class="display-3 text-white mb-md-4">Yuqori professional tozalash xizmatlari</h1>
                            <a href="" class="btn btn-primary">Iqtibos olish</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" src="{{asset('asset/img/carousel-3.jpg')}}" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Tozalash xizmatlari</h5>
                            <h1 class="display-3 text-white mb-md-4">Tajribali va tajribali tozalovchilar</h1>
                            <a href="" class="btn btn-primary">Iqtibos olish</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 p-0">
                <div class="contact-info-item d-flex align-items-center justify-content-center bg-primary text-white py-4 py-lg-0">
                    ...
                    <div class="">
                        <h5 class="mb-2">Bizning ofisimiz</h5>
                        <p class="m-0">123 Street, Nyu-York, AQSh</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 p-0">
                <div class="contact-info-item d-flex align-items-center justify-content-center bg-secondary text-white py-4 py-lg-0">
                    ...
                    <div class="">
                        <h5 class="mb-2">Bizga elektron pochta</h5>
            ...
            <div class="col-lg-4 p-0">
                <div class="contact-info-item d-flex align-items-center justify-content-center bg-primary text-white py-4 py-lg-0">
                    ...
                    <div class="">
                        <h5 class="mb-2">Bizga qo'ng'iroq qiling</h5>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex flex-column align-items-center justify-content-center bg-about rounded h-100 py-5 px-3">
                        ...
                        <h2 class="text-white m-0">Yillik Tajriba</h2>
                    </div>
                </div>
                <div class="col-lg-7 pt-5 pb-lg-5">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">Biz haqimizda bilib oling</h6>
                    <h1 class="mb-4 section-title">Biz eng yaxshi tozalash xizmatlarini taqdim etamiz</h1>
                    <h5 class="text-muted font-weight-normal mb-3">Ularning dardi haqiqatdir. Bu juda qiziq, lekin haqiqat shundaki, dunyo shunchaki dunyo</h5>
                    <p>text</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 400px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="{{asset('asset/img/feature.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row m-0 portfolio-container">
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img">
                            <img class="img-fluid w-100" src="{{asset('asset/img/portfolio-1.jpg')}}" alt="">
                        </div>
                        <div class="portfolio-text bg-primary">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-1.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img">
                            <img class="img-fluid w-100" src="{{asset('asset/img/portfolio-2.jpg')}}" alt="">
                        </div>
                        <div class="portfolio-text bg-primary">
                            <h4 class="font-weight-bold mb-4">Project Name</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-2.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-primary">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-3.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img">
                            <img class="img-fluid w-100" src="{{asset('asset/img/portfolio-4.jpg')}}" alt="">
                        </div>
                        <div class="portfolio-text bg-primary">
                            <h4 class="font-weight-bold mb-4">Project Name</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-4.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img">
                            <img class="img-fluid w-100" src="{{asset('asset/img/portfolio-5.jpg')}}" alt="">
                        </div>
                        <div class="portfolio-text bg-primary">
                            <h4 class="font-weight-bold mb-4">Project Name</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-5.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img">
                            <img class="img-fluid w-100" src="{{asset('asset/img/portfolio-6.jpg')}}" alt="">
                        </div>
                        <div class="portfolio-text bg-primary">
                            <h4 class="font-weight-bold mb-4">Project Name</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <a class="btn btn-sm btn-secondary m-1" href="{{asset('asset/img/portfolio-6.jpg')}}" data-lightbox="portfolio">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded w-100" src="{{asset('asset/img/blog-1.jpg')}}" alt="">
                        <div class="blog-date">
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded w-100" src="{{asset('asset/img/blog-2.jpg')}}" alt="">
                        <div class="blog-date">
                            <h4 class="font-weight-bold mb-n1">01</h4>
                            <small class="text-white text-uppercase">Jan</small>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded w-100" src="{{asset('asset/img/blog-3.jpg')}}" alt="">
                        <div class="blog-date">
                            <h4 class="font-weight-bold mb-n1">01</h4>
                            <small class="text-white text-uppercase">Jan</small>
                        </div>
